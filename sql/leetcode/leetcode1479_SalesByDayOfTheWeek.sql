/*
https://circlecoder.com/sales-by-day-of-the-week/
...
-- The main idea to create a pivot table
...
SELECT
    ...
    , SUM(CASE WHEN dayofweek(o.order_date) = 3 THEN quantity ELSE 0 END) AS Tusday
    ...
    , SUM(CASE WHEN dayofweek(o.order_date) = 7 THEN quantity ELSE 0 END) AS Saturdays
FROM Items i
LEFT JOIN Orders o
